    ...
    <div className="w-full lg:w-1/2 xl:w-1/3 lg:mb-32">
      ...
      <div className="m-4 bg-white rounded-lg p-6 lg:h-full lg:flex lg:flex-wrap lg:mx-5">
        ...
        <ul className="flex justify-between items-end mt-5 w-full">
          ...
          <div className="flex">
            <li>
              <a className="mr-2" href={props.project.github} target="_blank">
                <FontAwesomeIcon
                  icon={["fab", "github"]}
                  size="2x"
            ...
            <li className="flex items-end">
              <a
                ...
                className={
                  props.project.link
                    ? `py-2 px-4 mx-2 rounded bg-pink hover:text-white hover:bg-dark-blue`
                    : `py-2 px-4 mx-2 rounded bg-pink pointer-events-none`
                }
              >
                Check it
              </a>
